...
Atuo como **Analista de Service Desk** com formação em *Análise e Desenvolvimento de Sistemas*, especializada em suporte técnico, administração de ambientes corporativos e otimização de processos.

* **Análise de Dados & Automação:** Construção de dashboards interativos em Power BI, consultas SQL avançadas e estruturação de indicadores para tomada de decisão.
* **Cybersecurity (Programa Mulher Digital):** Foco em segurança da informação, gestão de acessos (IAM), proteção de dados corporativos e boas práticas de rede.

---

### Certificações & Badges Verificados

| Instituição | Certificação / Especialização |
| :--- | :--- |
